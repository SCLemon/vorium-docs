...
export default {
    ...
    setup(){
        ...
        const url = process.env.BASE_URL+'demo-code/CEditor/step1.bash'
        const url2 = process.env.BASE_URL+'demo-code/CEditor/step2.js'
        const url3 = process.env.BASE_URL+'demo-code/CEditor/step3.js'
        const url4 = process.env.BASE_URL+'demo-code/CEditor/step4.vue'
        let demo_code = ref('');
        let demo_code2 = ref('');
        let demo_code3 = ref('');
        let demo_code4 = ref('');
