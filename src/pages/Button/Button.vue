...
export default {
    ...
    setup(){
        ...
        const parameters = [
            {
                ...
                type: 'String',
                necessity: 'Optional',
                options: 'primary | danger | warning | success | info | ghost',
                default: 'primary'
            },
            {
                name: 'size',
            ...
            {
                name: 'round',
                description: 'Applies a rounded-pill appearance to the button.',
                type: 'Boolean',
                necessity: 'Optional',
                options: 'true | false',
                default: 'false'
            ...
            {
                name: 'loading',
                description: 'Displays the loading state and temporarily disables the button.',
                type: 'Boolean',
                necessity: 'Optional',
                options: 'true | false',
                default: 'false'
            ...
            {
                name: 'loadingText',
                description: 'Custom text displayed while the button is in loading state.',
                type: 'String',
                necessity: 'Optional',
                options: 'Any string',
                default: 'Loading'
        ...
        return {
            ...
            PlusIcon, CheckIcon, CloseIcon, ExclamationIcon, MenuIcon, UserIcon
        }
    }
}
</script>
