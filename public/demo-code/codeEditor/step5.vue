<!-- Paste this source code into ./components/VCodeEditor.vue (relative to CodeEditor.vue) -->
<template>
        ...
        <div v-if="header" :class="`v-code-editor-header v-code-editor-header-${theme}`" :style="headerStyle">
            ...
            <div class="v-code-editor-header-action">
                <div v-if="!hasActionSlot">
                    ...
                    <div class="v-code-editor-icon-wrapper" v-else-if="copyStatus == 1"><VIcon :icon="CheckIcon" class="v-code-editor-icon"></VIcon>COPYIED</div>
...
monaco.editor.setTheme('vorium-dark')
monaco.editor.setTheme('vorium-light')
